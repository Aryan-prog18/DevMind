...
return (
          ...
          <main className="mx-auto w-full max-w-6xl flex-1 px-5 py-8 lg:px-8 lg:py-10">
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-3">
                ...
                {backendStatus && (
                  <span
                    className={`rounded-full border px-2.5 py-1 text-xs font-medium ${backendStatus.className}`}
                  >
                    {backendStatus.label}
                  </span>
                )}
              ...
              <h2 className="mt-2 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                Build with more context.
              </h2>

              <p className="mt-3 max-w-xl text-sm leading-6 text-slate-400 sm:text-base">
                Connect a project to ask questions, explore your codebase,
                and move from idea to answer faster.
              </p>
            </div>
  ...
  isRepositoryReady={isRepositoryReady}
  setIsRepositoryReady={setIsRepositoryReady}

  isAnalyzingRepository={isAnalyzingRepository}
  setIsAnalyzingRepository={setIsAnalyzingRepository}
/>
